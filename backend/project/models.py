...
class Project(models.Model):
    ...
    category = models.CharField(max_length=100, verbose_name=_("Project Category"), blank=True)
    skills_required = models.TextField(verbose_name=_("Skills Required"), blank=True)
    closing_date = models.DateTimeField(verbose_name=_("Project Closing Date"))
