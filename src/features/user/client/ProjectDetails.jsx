...
// import { useParams } from "react-router-dom";
// import axios from "axios";
// import { Container, Typography, Box, CircularProgress, Button, MenuItem, Select } from "@mui/material";
...
//     try {
//       await axios.put(`http://localhost:8000/project/proposals/${proposalId}/`, { status });
...
const ProjectDetails = () => {
 ...
 const handleProposalStatusChange = async (proposalId, status) => {
  try {
    // Fetch the current proposal data to include all required fields
