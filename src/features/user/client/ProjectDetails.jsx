...
const ProjectDetails = () => {
  ...
  if (!project || !project.client) {
    return <Typography>Error: Project or Client data is missing.</Typography>;
  }

  console.log('Client ID for CreateContract:', project.client); // Ensure this logs correctly
    ...
    <Container component="main" maxWidth="md">
      ...
      {showCreateContract && selectedProposal && (
        <CreateContract
          ...
          proposalId={selectedProposal.id}
          freelancerId={selectedProposal.freelancer.id}
          clientId={project.client} // Ensure this is passed correctly
        />
      )}
    </Container>
  );
