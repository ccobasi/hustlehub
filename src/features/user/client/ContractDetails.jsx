...
//       console.log('Updating contract with data:', updatedData);
...
//       // Refresh contract details after updating contract status
...
//               Contract for {contract.project.title}
//             </Typography>
//             {contract.client && (
//               <Typography variant="h6" sx={{ mb: 1 }}>
//                 Client: {contract.client.first_name} {contract.client.last_name}
//               </Typography>
//             )}
//             {contract.freelancer && (
//               <Typography variant="h6" sx={{ mb: 1 }}>
//                 Freelancer: {contract.freelancer.first_name} {contract.freelancer.last_name}
//               </Typography>
//             )}
...
//               <strong>Rate:</strong> #{contract.rate}
//             </Typography>
//             <Typography variant="body2" sx={{ mb: 1 }}>
//               <strong>Duration:</strong> {contract.duration} days
//             </Typography>
//             <Typography variant="body2" sx={{ mb: 1 }}>
